...
export const productCategories = [
  ...
  },
  {
    ...
    description: "Sapatas lisas customizáveis em formatos redondo e quadrado, com haste ou fixacao por parafuso.",
    baseType: "base lisa",
    primaryFixation: "apoio plano ou parafuso",
    image: {
      src: "/brand/categoria-sapata-base-lisa.png",
    ...
    formats: [
      {
        ...
        skuPrefix: "BF-BL-RD",
        description: "Para pés e bases com área circular de contato.",
        fixation: "apoio plano, haste ou parafuso",
        applications: ["poltronas", "sofás", "bases circulares"],
        status: "active",
        drawingType: "base-round",
        calibratedPricingCategorySlug: "sapata-base-lisa",
        ...
        manufacturing: {
          screwClearance: {
            ...
            minimumWallMm: 3,
            baseHeightKey: "alturaBase",
            minimumBaseHeightMm: 2
          }
        },
        priceBaseBrl: 29,
        priceFactor: 0.34,
        ...
        parameters: [
          ...
          toggle("parafuso", "Furo para parafuso", false),
          dimension("diametroParafuso", "Diametro do furo", 2, 8, 3, "mm", 0.1, { dependsOn: "parafuso" }),
        ...
        notes: ["O furo e parametrico; o parafuso metalico nao esta incluso."]
      },
      {
        slug: "quadrada",
        name: "Lisa quadrada",
        ...
        drawingType: "base-rect",
        calibratedPricingCategorySlug: "sapata-base-lisa",
        calibratedPricingFamilySlug: "sapata-lisa-quadrada",
        manufacturing: {
          screwClearance: {
            sizeKeys: ["tamanhoBaseX", "tamanhoBaseY"],
            screwDiameterKey: "diametroParafuso",
  ...
  },
  {
    slug: "sapata-u",
    name: "Sapata U",
    eyebrow: "Encaixe por pressao em perfil",
    description: "Sapatas em U para perfis e chapas, com ou sem haste.",
    baseType: "perfil em U",
    primaryFixation: "encaixe por pressao",
    image: {
      src: "/products/final/sapata-u-family-v2.png",
      alt: "Sapata Baseforma em U para perfis e chapas"
    },
    applications: ["estruturas metalicas", "mobiliario", "perfis e chapas"],
    colors: ["Preta"],
    finishes: [],
    formats: [
      {
        ...
        name: "Sapata U",
        skuPrefix: "BF-SU",
        description: "Para perfis e chapas com encaixe por pressao.",
        fixation: "encaixe por pressao",
        applications: ["estruturas metalicas", "mobiliario", "perfis e chapas"],
        status: "active",
        drawingType: "base-u",
        ...
        leadTimeBaseDays: 5,
        parameters: [
          dimension("diametro", "Diametro", 5, 60, 17.8, "mm", 0.1),
          dimension("espessura", "Espessura", 0.5, 3, 1.5, "mm", 0.1),
          dimension("comprimento", "Comprimento", 5, 100, 29.4, "mm", 0.1),
          toggle("pescoco", "Haste", false)
        ],
        notes: ["Modelos com e sem haste validados em CAD, fatiamento e cobertura de preco."]
      }
    ]
  },
  {
    slug: "sapata-pino",
    name: "Sapata com pino",
    eyebrow: "Pino de encaixe por medida",
    description: "Pinos inseridos para composicoes e reposicoes sob medida.",
    baseType: "pino inserido",
    primaryFixation: "encaixe",
    image: {
      src: "/brand/categoria-sapata-base-lisa.png",
      alt: "Pino inserido Baseforma"
    },
    applications: ["mobiliario", "reposicao", "componentes de encaixe"],
    colors: ["Preta"],
    finishes: [],
    formats: [
      {
        ...
        name: "Pino inserido",
        skuPrefix: "BF-PN-IN",
        description: "Pino de TPU para composicoes e reposicoes por medida.",
        fixation: "encaixe",
        applications: ["mobiliario", "reposicao", "componentes de encaixe"],
        status: "active",
        drawingType: "base-pin",
        calibratedPricingCategorySlug: "sapata-pino",
        priceBaseBrl: 0,
        priceFactor: 0,
        leadTimeBaseDays: 5,
        parameters: [
          dimension("diametro", "Diametro", 1, 15, 5.7, "mm", 0.1),
          dimension("alturaBase", "Altura", 1, 20, 5, "mm", 0.1)
        ],
        notes: ["Modelo parametrico, fatiamento e cobertura de preco validados."]
      }
    ]
  }
];
...
export function validateConfiguration(format, values) {
  ...
  if (format?.status !== "active") {
    issues.push("Produto em validacao tecnica; a compra direta ainda nao esta disponivel.");
  }

  if (values?.pescoco && values?.parafuso) {
    issues.push("Escolha haste ou fixacao por parafuso; as duas opcoes nao podem ser combinadas.");
  }
...
export function calculatePriceBreakdown(format, values, quantity = 1) {
  ...
  const pricingAvailable = format?.status === "active" && !["slicer_dataset_missing", "invalid_configuration"].includes(resolved.pricingMode);
  const pricingUnavailableReason = pricingAvailable
    ? ""
    : format?.status !== "active"
      ? "Produto em validacao tecnica; preco e compra direta ainda nao estao disponiveis."
