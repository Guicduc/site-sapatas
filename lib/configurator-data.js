...
const legacyProductCategories = [
  {
    ...
    description:
      "Ponteiras sob medida para tubos redondos, retangulares e oblongos, com encaixe sob pressão e ajuste de interferencia.",
    baseType: "tubo",
  ...
  },
  {
    ...
    baseType: "base lisa",
    primaryFixation: "adesivo, parafuso ou fita tecnica",
    image: {
  ...
  {
    slug: "encaixe-u-chapa",
    name: "Encaixe U para chapa",
    eyebrow: "Proteção para chapa e pé lâmina",
    description:
      "Sapata em U para tubos redondos variados.",
    baseType: "chapa",
    primaryFixation: "encaixe U por pressão",
    image: {
      src: "/brand/categoria-sapata-base-lisa.png",
      alt: "Encaixe U Traço Base para chapa e pé lâmina"
    },
    applications: ["chapa dobrada", "pes lamina", "banquinhos", "bases metalicas"],
    colors: ["Grafite", "Areia", "Terracota", "Verde mineral"],
    finishes: ["fosco tecnico", "encaixe por pressao", "proteção de borda"],
    formats: [
      {
        slug: "u-chapa",
        name: "Encaixe U para chapa",
...
export const productCategories = [
  {
    ...
    image: {
      src: "/brand/categoria-ponteira-interna-tubo.png",
      alt: "Sapatas Traco Base para tubos redondos, quadrados e oblongos"
    },
    applications: ["cadeiras", "mesas", "serralheria", "mobiliario autoral"],
    colors: ["Preta"],
    finishes: [],
    formats: [
      {
        ...
        leadTimeBaseDays: 5,
        parameters: [
          dimension("diametroInterno", "Diametro interno", 8, 100, 22, "mm"),
          dimension("diametroBase", "Diametro da base", 8, 100, 28, "mm"),
          dimension("profundidadeInsercao", "Profundidade de insercao", 4, 100, 18, "mm"),
          dimension("alturaApoio", "Altura de apoio", 2, 100, 8, "mm")
        ],
        notes: ["Meca o tubo por dentro, depois da pintura ou cromagem."]
      },
      {
        slug: "quadrado",
        name: "Tubo quadrado",
        ...
        leadTimeBaseDays: 6,
        parameters: [
          dimension("larguraInterna", "Largura interna", 8, 100, 30, "mm"),
          dimension("alturaInterna", "Altura interna", 8, 100, 30, "mm"),
          dimension("parede", "Espessura da parede", 0.8, 4, 1.5, "mm", 0.1),
          dimension("profundidadeInsercao", "Profundidade de insercao", 4, 100, 20, "mm"),
          dimension("alturaBase", "Altura da base", 2, 100, 8, "mm")
        ],
      ...
      },
      {
        ...
        leadTimeBaseDays: 8,
        parameters: [
          dimension("larguraInterna", "Largura interna", 8, 100, 36, "mm"),
          dimension("alturaInterna", "Altura interna", 8, 100, 18, "mm"),
          dimension("raioCanto", "Raio aproximado", 1, 50, 9, "mm"),
          dimension("profundidadeInsercao", "Profundidade de insercao", 4, 100, 18, "mm")
        ],
  ...
  },
  {
    slug: "sapata-base-lisa",
    name: "Sapata lisa",
    eyebrow: "Apoio plano customizavel",
    description: "Sapatas lisas customizaveis em formatos redondo e quadrado.",
    baseType: "base lisa",
    primaryFixation: "apoio plano",
    image: {
      src: "/brand/categoria-sapata-base-lisa.png",
      alt: "Sapatas Traco Base para bases lisas redondas e quadradas"
    },
    applications: ["poltronas", "banquinhos", "bases metalicas", "moveis autorais"],
    colors: ["Preta"],
    finishes: [],
    formats: [
      {
        ...
        leadTimeBaseDays: 4,
        parameters: [
          dimension("diametro", "Diametro", 8, 100, 28, "mm"),
          dimension("altura", "Altura", 2, 100, 6, "mm")
        ],
        notes: ["Modelo parametrico disponivel para o MVP."]
      },
      {
        slug: "quadrada",
        name: "Lisa quadrada",
        skuPrefix: "TB-BL-QD",
        description: "Para bases planas com area de contato quadrada.",
        fixation: "apoio plano",
        applications: ["chapa metalica", "banquinhos", "bases quadradas"],
        status: "active",
        drawingType: "base-rect",
        priceBaseBrl: 36,
        priceFactor: 0.28,
        leadTimeBaseDays: 5,
        parameters: [
          dimension("comprimento", "Comprimento", 8, 100, 50, "mm"),
          dimension("largura", "Largura", 8, 100, 50, "mm"),
          dimension("altura", "Altura", 2, 100, 7, "mm"),
          dimension("raioCanto", "Raio dos cantos", 0, 50, 4, "mm")
        ],
        notes: ["Modelo parametrico disponivel para o MVP."]
      }
    ]
  },
  {
    ...
    eyebrow: "Encaixe U para apoio em tubo",
    description:
      "Sapata em U customizavel para tubos e apoios que pedem protecao de borda.",
    baseType: "tubo",
    primaryFixation: "encaixe U por pressao",
    image: {
      src: "/brand/categoria-sapata-base-lisa.png",
      alt: "Sapata U Traco Base para tubos"
    },
    ...
    formats: [
      {
        slug: "u-tubo",
        name: "Sapata U para tubo",
        skuPrefix: "TB-TB-U",
        description: "Para tubo ou apoio que pode receber uma sapata em U envolvendo a borda.",
        fixation: "encaixe U por pressao",
        applications: ["tubos", "banquinhos", "bases metalicas"],
        status: "active",
        drawingType: "base-u",
        priceBaseBrl: 44,
        priceFactor: 0.32,
        leadTimeBaseDays: 6,
        parameters: [
          dimension("espessuraChapa", "Espessura do tubo/borda", 1.5, 100, 3, "mm", 0.1),
          dimension("profundidadeCanal", "Profundidade do canal", 4, 100, 16, "mm"),
          dimension("comprimento", "Comprimento", 8, 100, 48, "mm"),
          dimension("alturaAparente", "Altura aparente", 2, 100, 8, "mm")
        ],
        notes: ["Modelo parametrico ainda sera desenvolvido; venda como customizavel no MVP."]
      }
    ]
  }
];
