...
export const productCategories = [
  ...
  },
  {
    ...
    description: "Sapatas lisas customizaveis em formatos redondo e quadrado, com ou sem pescoço.",
    baseType: "base lisa",
    ...
    formats: [
      {
        ...
        parameters: [
          ...
          toggle("pescoco", "Pescoço", false),
          dimension("alturaPescoco", "Altura do pescoço", 5, 35, 12, "mm", 1, { dependsOn: "pescoco" }),
          dimension("diametroPescoco", "Diametro do pescoço", 3, 15, 8, "mm", 1, { dependsOn: "pescoco" })
        ],
