...
export function calculateSlicedCost({ materialGrams, printMinutes, quantity = 1 }) {
  ...
  const machineCostBrl = printHours * assumptions.machineCostBrlPerHour * safeQuantity;
  const energyCostBrl = printHours * assumptions.energyCostBrlPerHour * safeQuantity;
  ...
  return {
    ...
    machineCostBrl: roundMoney(machineCostBrl / safeQuantity),
