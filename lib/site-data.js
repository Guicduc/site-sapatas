...
function variantFromFormat(categorySlug, formatSlug, overrides = {}) {
  ...
  const isDraft = overrides.status === "draft" || !format;
  ...
  return {
    ...
    salesUnit: "unidade",
    priceBrl: isDraft ? null : (overrides.priceBrl ?? defaultPrice),
...
function withFamilyImages(family) {
  const images = family.status === "draft" ? [] : finalProductImages(family.slug);
...
export const families = [
  ...
  },
  {
    ...
    seoDescription:
      "Sapata lisa redonda preta sob medida, com opção de furo para fixação por parafuso.",
    ...
    heroDescription:
      "Linha sob medida com apoio liso, haste ou furo central configurável para fixação por parafuso. O parafuso metálico não está incluso.",
    ...
    fixation: "apoio plano, haste ou furo para parafuso",
    compatibilitySummary: "Medidas customizáveis até 150 x 150 mm.",
    parameterSummary: ["lisa redonda", "furo de 2 a 8 mm", "cor preta"],
    highlights: ["fixação por parafuso opcional", "sem quantidade mínima", "cor preta padrão"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
    ...
    faqs: [
      { question: "Qual cor está disponível agora?", answer: "Apenas preta." },
      { question: "Existe acabamento?", answer: "Não. Acabamento adicional não se aplica aos produtos da linha atual." },
      { question: "O parafuso está incluso?", answer: "Não. A peça recebe o furo configurado; escolha o parafuso compatível com a base onde ela será instalada." },
      { question: "Qual o limite de medida?", answer: "Medidas até 150 x 150 mm são tratadas como vendáveis." }
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Sapata lisa quadrada preta sob medida, com opção de furo para fixação por parafuso.",
    ...
    fixation: "apoio plano, haste ou furo para parafuso",
    compatibilitySummary: "Medidas customizáveis até 150 x 150 mm.",
    parameterSummary: ["lisa quadrada", "furo de 2 a 8 mm", "cor preta"],
    highlights: ["fixação por parafuso opcional", "sem quantidade mínima", "cor preta padrão"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
  ...
  },
  {
    ...
    name: "Sapata U",
    eyebrow: "Modelo paramétrico disponível",
    seoTitle: "Sapata U para perfis e chapas | Baseforma",
    seoDescription:
      "Sapata U em TPU para perfis e chapas, configurável por diâmetro, espessura, comprimento e opção de haste.",
    keyword: "sapata U para perfil",
    tagline: "Componente em U sob medida, com ou sem haste.",
    heroTitle: "Sapata U para perfis e chapas sob medida.",
    heroDescription:
      "Configure diâmetro, espessura, comprimento e a opção de haste. Os arquivos de produção e a precificação foram validados com dados reais do Orca Slicer.",
    url: "/familias/sapata-u",
    priceFromBrl: 0.75,
    leadTimeDays: 5,
    salesUnit: "unidade",
    defaultMaterial: "TPU",
    availableColors: ["Preta"],
    applications: ["perfis metálicos", "chapas", "estruturas de mobiliário", "reposições técnicas"],
    fixation: "encaixe em U",
    compatibilitySummary: "Diâmetro de 5 a 30 mm, espessura de 0,5 a 3 mm e comprimento de 5 a 100 mm.",
    parameterSummary: ["encaixe em U", "diâmetro", "espessura", "comprimento"],
    highlights: ["modelo paramétrico validado", "com ou sem haste", "sem quantidade mínima"],
    fitTitle: "Onde será aplicada",
    fitDescription:
      "Perfis, chapas e estruturas que precisam de uma proteção de encaixe em U configurada pela medida real.",
    asideTitle: "Pronta para configurar",
    asideDescription:
      "Escolha as medidas, a variante com ou sem haste e a quantidade diretamente no configurador.",
    faqs: [
      { question: "Já posso comprar?", answer: "Sim. A família passou pela validação de CAD, fatiamento e cobertura de preço." },
      { question: "Quais medidas posso configurar?", answer: "Diâmetro, espessura, comprimento e a variante com ou sem haste." },
      { question: "Posso pedir uma medida específica?", answer: "Sim. Envie o contexto e as medidas pelo projeto especial para análise técnica." }
    ],
    variants: [variantFromFormat("sapata-u", "u", { leadTimeDays: 5 })]
  },
  {
    slug: "sapata-pino-inserido",
    status: "active",
    name: "Sapata com pino inserido",
    eyebrow: "Modelo paramétrico disponível",
    seoTitle: "Sapata com pino inserido para mobiliário | Baseforma",
    seoDescription:
      "Sapata com pino inserido em TPU, configurável por diâmetro e altura para composições e reposições sob medida.",
    keyword: "sapata com pino inserido",
    tagline: "Sapata com pino de encaixe configurável por medida.",
    heroTitle: "Sapata com pino inserido sob medida.",
    heroDescription:
      "Configure o diâmetro e a altura do pino. O modelo paramétrico e a precificação foram validados com dados reais do Orca Slicer.",
    url: "/familias/sapata-pino-inserido",
    priceFromBrl: 0.3,
    leadTimeDays: 5,
    salesUnit: "unidade",
    defaultMaterial: "TPU",
    availableColors: ["Preta"],
    applications: ["pés de móveis", "encaixes com pino", "reposição técnica", "mobiliário sob medida"],
    fixation: "pino inserido",
    compatibilitySummary: "Diâmetro de 1 a 15 mm e altura de 1 a 20 mm.",
    parameterSummary: ["pino inserido", "diâmetro", "altura da base"],
    highlights: ["modelo paramétrico validado", "sem quantidade mínima", "cor preta padrão"],
    fitTitle: "Onde será aplicada",
    fitDescription:
      "Pés e estruturas com ponto de encaixe por pino que precisam de reposição ou composição sob medida.",
    asideTitle: "Pronta para configurar",
    asideDescription:
      "Escolha diâmetro, altura e quantidade no configurador. Aplicações fora dos limites seguem para projeto especial.",
    faqs: [
      { question: "Quais medidas posso configurar?", answer: "Diâmetro entre 1 e 15 mm e altura entre 1 e 20 mm." },
      { question: "Qual material e cor estão disponíveis?", answer: "TPU na cor preta." },
      { question: "Existe quantidade mínima?", answer: "Não. A linha atual não aplica quantidade mínima." }
    ],
    variants: [variantFromFormat("sapata-pino", "pino-inserido", { leadTimeDays: 5 })]
  },
  
].map(withFamilyImages);

export const applications = [...new Set(families.filter(isPublicFamily).flatMap((family) => family.applications))];

export const fixations = [...new Set(families.filter(isPublicFamily).map((family) => family.fixation))];
...
export function getRelatedFamilies(slug) {
  return families.filter((family) => family.slug !== slug && isPublicFamily(family));
}
