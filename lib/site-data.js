import { productCategories } from "./configurator-data";

export const siteUrl = "https://www.tracobase.com.br";

export { colorMap } from "./brand-colors";

export const brand = {
  name: "Traço Base",
  shortName: "Traço",
  tagline: "Sapatas 3D sob demanda para mobiliário",
  description:
    "Componentes técnicos para mobiliário com catálogo parametrizado, produção sob demanda e desenvolvimento especial.",
  whatsappNumber: "5511999990000",
  email: "comercial@tracobase.com.br",
  city: "São Paulo",
  country: "Brasil"
};
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "O modelo comercial recomenda venda por kit ou por lote mínimo para manter a operação saudável."
      },
      {
    ...
    variants: [
      {
        ...
        priceBrl: 115.04,
        leadTimeDays: 5,
        technicalFile: "stl/aprovados/TB-RD-PF-2008-GRA.stl"
      },
      {
        sku: "TB-RD-PF-2512-ARE",
        ...
        priceBrl: 160.24,
        leadTimeDays: 6,
        technicalFile: "stl/aprovados/TB-RD-PF-2512-ARE.stl"
      },
      {
        sku: "TB-RD-PF-2512-GRA",
        ...
        priceBrl: 160.24,
        leadTimeDays: 6,
        technicalFile: "stl/aprovados/TB-RD-PF-2512-GRA.stl"
      },
      {
        sku: "TB-RD-PF-3016-TER",
        ...
        priceBrl: 234.92,
        leadTimeDays: 7,
        technicalFile: "stl/aprovados/TB-RD-PF-3016-TER.stl"
      }
    ]
  },
  {
    ...
    variants: [
      {
        ...
        priceBrl: 177.56,
        leadTimeDays: 6,
        technicalFile: "stl/aprovados/TB-QD-PF-2210-GRA.stl"
      },
      {
        sku: "TB-QD-PF-2612-ARE",
        ...
        priceBrl: 239.04,
        leadTimeDays: 6,
        technicalFile: "stl/aprovados/TB-QD-PF-2612-ARE.stl"
      },
      {
        sku: "TB-QD-PF-2612-GRA",
        ...
        priceBrl: 239.04,
        leadTimeDays: 6,
        technicalFile: "stl/aprovados/TB-QD-PF-2612-GRA.stl"
      },
      {
        sku: "TB-QD-PF-3218-VMN",
        ...
        priceBrl: 423.32,
        leadTimeDays: 7,
        technicalFile: "stl/aprovados/TB-QD-PF-3218-VMN.stl"
      }
    ]
  },
  {
    ...
    variants: [
      {
        ...
        priceBrl: 76.76,
        leadTimeDays: 4,
        technicalFile: "stl/aprovados/TB-SL-AD-1803-GRA.stl"
      },
      {
        sku: "TB-SL-AD-2210-ARE",
        ...
        priceBrl: 104.88,
        leadTimeDays: 4,
        technicalFile: "stl/aprovados/TB-SL-AD-2210-ARE.stl"
      },
      {
        sku: "TB-SL-AD-2210-GRA",
        ...
        priceBrl: 104.88,
        leadTimeDays: 4,
        technicalFile: "stl/aprovados/TB-SL-AD-2210-GRA.stl"
      },
      {
        sku: "TB-SL-AD-3008-AZP",
        ...
        priceBrl: 122.08,
        leadTimeDays: 5,
        technicalFile: "stl/aprovados/TB-SL-AD-3008-AZP.stl"
      }
    ]
  }
];
...
function variantFromFormat(categorySlug, formatSlug, overrides = {}) {
  ...
  const compatible = `customizavel ate 100 x 100 mm`;

  return {
    sku: `${format?.skuPrefix || "TB-MVP"}-CUSTOM-PRE`,
    label: overrides.label || `${format?.name || "Sapata"} preta customizavel`,
    dimensions: {
      baseMm: base,
      heightMm: height,
    ...
    color: "Preta",
    material: "TPU",
    finish: "nao se aplica",
    salesUnit: "unidade",
    priceBrl: overrides.priceBrl || format?.priceBaseBrl || 29,
    leadTimeDays: overrides.leadTimeDays || format?.leadTimeBaseDays || 5,
    technicalFile: overrides.technicalFile || "modelo-parametrico"
  };
}
...
export const families = [
  {
    slug: "sapata-tubo-redondo",
    name: "Sapata para tubo redondo",
    eyebrow: "Sapata customizavel para tubo",
    seoTitle: "Sapata para tubo redondo sob medida | Traco Base",
    seoDescription:
      "Sapata preta sob medida para tubo redondo, customizavel ate 100 x 100 mm para mobiliario.",
    keyword: "sapata para tubo redondo",
    tagline: "Sapata preta customizavel para tubos redondos medidos por dentro.",
    heroTitle: "Sapata para tubo redondo customizavel ate 100 x 100 mm.",
    heroDescription:
      "Linha MVP para tubos redondos. A cor padrao e preta, sem acabamento adicional e sem quantidade minima.",
    url: "/familias/sapata-tubo-redondo",
    priceFromBrl: 34,
    leadTimeDays: 5,
    salesUnit: "unidade",
    ...
    applications: ["mesas metalicas", "cadeiras", "banquetas", "serralheria"],
    fixation: "press-fit interno",
    compatibilitySummary: "Medidas customizaveis ate 100 x 100 mm.",
    parameterSummary: ["tubo redondo", "ate 100 x 100 mm", "cor preta"],
    highlights: ["customizavel por medida", "sem quantidade minima", "cor preta no MVP"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
      "Mesas, cadeiras, banquetas e estruturas tubulares redondas que precisam de sapata sob medida.",
    asideTitle: "Modelo parametrico em desenvolvimento",
    asideDescription:
      "Esta familia ja faz parte do MVP vendavel; o modelo parametrico sera desenvolvido na etapa de produto.",
    faqs: [
      {
        question: "Qual cor esta disponivel no MVP?",
        answer: "Apenas preta."
      },
      {
        question: "Existe quantidade minima?",
        answer: "Nao. A venda do MVP nao aplica quantidade minima."
      },
      {
        question: "Qual o limite de medida?",
        answer: "Medidas ate 100 x 100 mm sao tratadas como vendaveis."
      }
    ],
    variants: [variantFromFormat("ponteira-interna-tubo", "redondo", { priceBrl: 34, leadTimeDays: 5 })]
  },
  {
    slug: "sapata-tubo-quadrado",
    name: "Sapata para tubo quadrado",
    eyebrow: "Sapata customizavel para tubo",
    seoTitle: "Sapata para tubo quadrado sob medida | Traco Base",
    seoDescription:
      "Sapata preta sob medida para tubo quadrado, customizavel ate 100 x 100 mm para mobiliario.",
    keyword: "sapata para tubo quadrado",
    tagline: "Sapata preta customizavel para tubos quadrados e metalon.",
    heroTitle: "Sapata para tubo quadrado customizavel ate 100 x 100 mm.",
    heroDescription:
      "Linha MVP para tubos quadrados. A cor padrao e preta, sem acabamento adicional e sem quantidade minima.",
    url: "/familias/sapata-tubo-quadrado",
    priceFromBrl: 42,
    leadTimeDays: 6,
    salesUnit: "unidade",
    defaultMaterial: "TPU",
    availableColors: ["Preta"],
    applications: ["mesas metalicas", "buffets", "aparadores", "serralheria"],
    fixation: "press-fit interno",
    compatibilitySummary: "Medidas customizaveis ate 100 x 100 mm.",
    parameterSummary: ["tubo quadrado", "ate 100 x 100 mm", "cor preta"],
    highlights: ["customizavel por medida", "sem quantidade minima", "cor preta no MVP"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
    ...
    asideDescription:
      "Esta familia ja faz parte do MVP vendavel; o modelo parametrico sera desenvolvido na etapa de produto.",
    faqs: [
      { question: "Qual cor esta disponivel no MVP?", answer: "Apenas preta." },
      { question: "Existe acabamento?", answer: "Nao. Acabamento nao se aplica aos produtos do MVP." },
      { question: "Qual o limite de medida?", answer: "Medidas ate 100 x 100 mm sao tratadas como vendaveis." }
    ],
    variants: [variantFromFormat("ponteira-interna-tubo", "quadrado", { priceBrl: 42, leadTimeDays: 6 })]
  },
  {
    slug: "sapata-tubo-oblongo",
    name: "Sapata para tubo oblongo",
    eyebrow: "Sapata customizavel para tubo",
    seoTitle: "Sapata para tubo oblongo sob medida | Traco Base",
    seoDescription:
      "Sapata preta sob medida para tubo oblongo, customizavel ate 100 x 100 mm para mobiliario.",
    keyword: "sapata para tubo oblongo",
    tagline: "Sapata preta customizavel para perfis oblongos e ovais.",
    heroTitle: "Sapata para tubo oblongo customizavel ate 100 x 100 mm.",
    heroDescription:
      "Linha MVP para tubos oblongos. A cor padrao e preta, sem acabamento adicional e sem quantidade minima.",
    ...
    defaultMaterial: "TPU",
    availableColors: ["Preta"],
    applications: ["cadeiras", "moveis importados", "reposicao", "serralheria"],
    fixation: "press-fit interno",
    compatibilitySummary: "Medidas customizaveis ate 100 x 100 mm.",
    parameterSummary: ["tubo oblongo", "ate 100 x 100 mm", "cor preta"],
    highlights: ["customizavel por medida", "sem quantidade minima", "cor preta no MVP"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
      "Perfis ovais ou oblongos em cadeiras, moveis importados e reposicoes fora de padrao.",
    asideTitle: "Modelo parametrico em desenvolvimento",
    asideDescription:
      "Esta familia ja faz parte do MVP vendavel; o modelo parametrico sera desenvolvido na etapa de produto.",
    faqs: [
      { question: "Qual cor esta disponivel no MVP?", answer: "Apenas preta." },
      { question: "Existe quantidade minima?", answer: "Nao. A venda do MVP nao aplica quantidade minima." },
      { question: "Qual o limite de medida?", answer: "Medidas ate 100 x 100 mm sao tratadas como vendaveis." }
    ],
    variants: [variantFromFormat("ponteira-interna-tubo", "oblongo", { priceBrl: 48, leadTimeDays: 8 })]
  },
  {
    slug: "sapata-lisa-redonda",
    name: "Sapata lisa redonda",
    eyebrow: "Modelo parametrico disponivel",
    seoTitle: "Sapata lisa redonda sob medida | Traco Base",
    seoDescription:
      "Sapata lisa redonda preta sob medida, customizavel ate 100 x 100 mm para mobiliario.",
    keyword: "sapata lisa redonda",
    tagline: "Sapata lisa redonda preta com modelo parametrico ja disponivel.",
    heroTitle: "Sapata lisa redonda customizavel ate 100 x 100 mm.",
    heroDescription:
      "Linha MVP com modelo parametrico ja disponivel. A cor padrao e preta, sem acabamento adicional e sem quantidade minima.",
    ...
    defaultMaterial: "TPU",
    availableColors: ["Preta"],
    applications: ["poltronas", "sofas", "bases circulares", "moveis autorais"],
    fixation: "apoio plano",
    compatibilitySummary: "Medidas customizaveis ate 100 x 100 mm.",
    parameterSummary: ["lisa redonda", "ate 100 x 100 mm", "cor preta"],
    highlights: ["modelo parametrico disponivel", "sem quantidade minima", "cor preta no MVP"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
      "Bases circulares, pes redondos e apoios planos que precisam de uma sapata lisa sob medida.",
    asideTitle: "Pronta para trabalhar nos modelos",
    asideDescription:
      "Esta e uma das familias com modelo parametrico disponivel para evoluir primeiro.",
    faqs: [
      { question: "Qual cor esta disponivel no MVP?", answer: "Apenas preta." },
      { question: "Existe acabamento?", answer: "Nao. Acabamento nao se aplica aos produtos do MVP." },
      { question: "Qual o limite de medida?", answer: "Medidas ate 100 x 100 mm sao tratadas como vendaveis." }
    ],
    variants: [variantFromFormat("sapata-base-lisa", "redonda", { priceBrl: 29, leadTimeDays: 4 })]
  },
  {
    slug: "sapata-lisa-quadrada",
    name: "Sapata lisa quadrada",
    eyebrow: "Modelo parametrico disponivel",
    seoTitle: "Sapata lisa quadrada sob medida | Traco Base",
    seoDescription:
      "Sapata lisa quadrada preta sob medida, customizavel ate 100 x 100 mm para mobiliario.",
    keyword: "sapata lisa quadrada",
    tagline: "Sapata lisa quadrada preta com modelo parametrico ja disponivel.",
    heroTitle: "Sapata lisa quadrada customizavel ate 100 x 100 mm.",
    heroDescription:
      "Linha MVP com modelo parametrico ja disponivel. A cor padrao e preta, sem acabamento adicional e sem quantidade minima.",
    ...
    defaultMaterial: "TPU",
    availableColors: ["Preta"],
    applications: ["chapa metalica", "banquinhos", "bases quadradas", "moveis autorais"],
    fixation: "apoio plano",
    compatibilitySummary: "Medidas customizaveis ate 100 x 100 mm.",
    parameterSummary: ["lisa quadrada", "ate 100 x 100 mm", "cor preta"],
    highlights: ["modelo parametrico disponivel", "sem quantidade minima", "cor preta no MVP"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
    ...
    variants: [variantFromFormat("sapata-base-lisa", "quadrada", { priceBrl: 36, leadTimeDays: 5 })]
  },
  {
    slug: "sapata-u-para-tubos",
    name: "Sapata U para tubos",
    eyebrow: "Sapata U customizavel",
    seoTitle: "Sapata U para tubos sob medida | Traco Base",
    seoDescription:
      "Sapata U preta sob medida para tubos, customizavel ate 100 x 100 mm para mobiliario.",
    keyword: "sapata U para tubos",
    tagline: "Sapata preta em U para tubos e apoios que pedem protecao de borda.",
    heroTitle: "Sapata U para tubos customizavel ate 100 x 100 mm.",
    heroDescription:
      "Linha MVP para encaixe em U. A cor padrao e preta, sem acabamento adicional e sem quantidade minima.",
    url: "/familias/sapata-u-para-tubos",
    priceFromBrl: 44,
    leadTimeDays: 6,
    salesUnit: "unidade",
    defaultMaterial: "TPU",
    availableColors: ["Preta"],
    applications: ["tubos", "banquinhos", "bases metalicas", "mobiliario autoral"],
    fixation: "encaixe U por pressao",
    compatibilitySummary: "Medidas customizaveis ate 100 x 100 mm.",
    parameterSummary: ["encaixe U", "ate 100 x 100 mm", "cor preta"],
    highlights: ["customizavel por medida", "sem quantidade minima", "cor preta no MVP"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
      "Tubos, bordas e apoios que precisam de uma sapata em U envolvendo a peca.",
    asideTitle: "Modelo parametrico em desenvolvimento",
    asideDescription:
      "Esta familia ja faz parte do MVP vendavel; o modelo parametrico sera desenvolvido na etapa de produto.",
    faqs: [
    ...
    variants: [variantFromFormat("sapata-u-tubo", "u-tubo", { priceBrl: 44, leadTimeDays: 6 })]
  }
];
