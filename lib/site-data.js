...
function variantFromFormat(categorySlug, formatSlug, overrides = {}) {
  ...
  const compatible = `customizável até 100 x 100 mm`;

  return {
    sku: `${format?.skuPrefix || "TB-CUSTOM"}-CUSTOM-PRE`,
...
export const families = [
  {
    ...
    seoTitle: "Sapata para tubo redondo sob medida | Traço Base",
    seoDescription:
      "Sapata preta sob medida para tubo redondo, customizável até 100 x 100 mm para mobiliário.",
    keyword: "sapata para tubo redondo",
    tagline: "Sapata preta customizável para tubos redondos medidos por dentro.",
    heroTitle: "Sapata para tubo redondo customizável até 100 x 100 mm.",
    heroDescription:
    ...
    fixation: "press-fit interno",
    compatibilitySummary: "Medidas customizáveis até 100 x 100 mm.",
    parameterSummary: ["tubo redondo", "até 100 x 100 mm", "cor preta"],
    ...
    asideTitle: "Modelo paramétrico em desenvolvimento",
    asideDescription:
      "Esta família já faz parte da linha atual; o modelo paramétrico será desenvolvido na etapa de produto.",
    faqs: [
      {
      ...
      },
      {
        ...
        answer: "Medidas até 100 x 100 mm são tratadas como vendáveis."
      }
    ],
  ...
  },
  {
    ...
    name: "Sapata para tubo quadrado",
    eyebrow: "Sapata customizável para tubo",
    seoTitle: "Sapata para tubo quadrado sob medida | Traço Base",
    seoDescription:
      "Sapata preta sob medida para tubo quadrado, customizável até 100 x 100 mm para mobiliário.",
    keyword: "sapata para tubo quadrado",
    tagline: "Sapata preta customizável para tubos quadrados e metalon.",
    heroTitle: "Sapata para tubo quadrado customizável até 100 x 100 mm.",
    heroDescription:
    ...
    fixation: "press-fit interno",
    compatibilitySummary: "Medidas customizáveis até 100 x 100 mm.",
    parameterSummary: ["tubo quadrado", "até 100 x 100 mm", "cor preta"],
    highlights: ["customizável por medida", "sem quantidade mínima", "cor preta padrão"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
    ...
    faqs: [
      ...
      { question: "Qual o limite de medida?", answer: "Medidas até 100 x 100 mm são tratadas como vendáveis." }
    ],
  ...
  },
  {
    ...
    eyebrow: "Sapata customizável para tubo",
    seoTitle: "Sapata para tubo oblongo sob medida | Traço Base",
    seoDescription:
      "Sapata preta sob medida para tubo oblongo, customizável até 100 x 100 mm para mobiliário.",
    keyword: "sapata para tubo oblongo",
    tagline: "Sapata preta customizável para perfis oblongos e ovais.",
    heroTitle: "Sapata para tubo oblongo customizável até 100 x 100 mm.",
    heroDescription:
    ...
    fixation: "press-fit interno",
    compatibilitySummary: "Medidas customizáveis até 100 x 100 mm.",
    parameterSummary: ["tubo oblongo", "até 100 x 100 mm", "cor preta"],
    highlights: ["customizável por medida", "sem quantidade mínima", "cor preta padrão"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
  ...
  },
  {
    ...
    seoTitle: "Sapata lisa redonda sob medida | Traço Base",
    seoDescription:
      "Sapata lisa redonda preta sob medida, customizável até 100 x 100 mm para mobiliário.",
    keyword: "sapata lisa redonda",
    tagline: "Sapata lisa redonda preta com modelo paramétrico já disponível.",
    heroTitle: "Sapata lisa redonda customizável até 100 x 100 mm.",
    heroDescription:
    ...
    compatibilitySummary: "Medidas customizáveis até 100 x 100 mm.",
    parameterSummary: ["lisa redonda", "até 100 x 100 mm", "cor preta"],
  ...
  },
  {
    ...
    eyebrow: "Modelo paramétrico disponível",
    seoTitle: "Sapata lisa quadrada sob medida | Traço Base",
    seoDescription:
      "Sapata lisa quadrada preta sob medida, customizável até 100 x 100 mm para mobiliário.",
    keyword: "sapata lisa quadrada",
    tagline: "Sapata lisa quadrada preta com modelo paramétrico já disponível.",
    heroTitle: "Sapata lisa quadrada customizável até 100 x 100 mm.",
    heroDescription:
      "Linha sob medida com modelo paramétrico já disponível. A cor padrão é preta, sem acabamento adicional e sem quantidade mínima.",
    ...
    fixation: "apoio plano",
    compatibilitySummary: "Medidas customizáveis até 100 x 100 mm.",
    parameterSummary: ["lisa quadrada", "até 100 x 100 mm", "cor preta"],
    highlights: ["modelo paramétrico disponível", "sem quantidade mínima", "cor preta padrão"],
    fitTitle: "Onde faz mais sentido",
    fitDescription:
