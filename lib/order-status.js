...
export const orderStatusLabels = {
  [ORDER_STATUS.NEEDS_TECHNICAL_REVIEW]: "Revisao tecnica",
  [ORDER_STATUS.PENDING_PAYMENT]: "Aguardando pagamento",
  [ORDER_STATUS.PAYMENT_PENDING]: "Pagamento pendente",
  [ORDER_STATUS.PAYMENT_FAILED]: "Pagamento nao aprovado",
  [ORDER_STATUS.PAID]: "Pago",
  [ORDER_STATUS.CAD_PENDING]: "Pago, aguardando CAD",
  [ORDER_STATUS.CAD_GENERATED]: "CAD gerado",
  [ORDER_STATUS.READY_FOR_PRINT]: "Pronto para impressao",
  [ORDER_STATUS.PAID_PENDING_REVIEW]: "Pago, aguardando revisao",
  [ORDER_STATUS.PAID_READY_FOR_PRODUCTION]: "Pago, pronto para producao",
  [ORDER_STATUS.IN_PRODUCTION]: "Em producao",
