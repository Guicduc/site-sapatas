...
// Os dois scripts de sapata com parafuso possuem um slider Grasshopper
// `Diam_Parafuso` (faixa bruta 0-10 mm), mas a malha validada foi gerada
// integralmente no default tecnico de 3 mm. Ele nao e parametro de venda.
const SCREW_BASE_TECHNICAL_DEFAULTS = {
  ...BASE_TECHNICAL_DEFAULTS,
  screwHoleDiameterMm: 3,
  screwCountersinkDiameterMm: 6,
