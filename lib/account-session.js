...
export const ACCOUNT_COOKIE = "traco-base-account";
export const ORDER_ACCESS_COOKIE = "traco-base-order-access";
...
function getSecret() {
  ...
  if (process.env.NODE_ENV !== "production") return "traco-base-local-development-only";
