...
export const invoiceStatusLabels = {
  ...
  [INVOICE_STATUS.API_PENDING]: "NF Mercado Pago pendente",
  [INVOICE_STATUS.API_ISSUED]: "NF Mercado Pago emitida",
  [INVOICE_STATUS.API_FAILED]: "Falha na NF Mercado Pago",
...
function getDefaultInvoiceMode() {
  ...
  return provider === "mercado_pago" ? provider : "manual";
}
