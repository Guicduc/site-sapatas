...
export const familyVisuals = {
  ...
  "sapata-com-parafuso-redonda": {
    family: image(
      "family",
      "Família",
      `${finalBasePath}/sapata-com-parafuso-redonda-family.png`,
      "Família de sapatas redondas com furo central para parafuso em diferentes medidas e cores"
    ),
    product: image(
      "product",
      "Produto",
      `${finalBasePath}/sapata-com-parafuso-redonda-product.png`,
      "Sapata redonda com furo central para parafuso em vista de produto final"
    ),
    manual: image(
      "manual",
      "Instalação",
      `${finalBasePath}/sapata-com-parafuso-redonda-manual.png`,
      "Sequência de instalação da sapata redonda com parafuso separado"
    ),
    usage: image(
      "usage",
      "Uso",
      `${finalBasePath}/sapata-com-parafuso-redonda-uso.png`,
      "Sapata redonda com parafuso aplicada sob pé de madeira"
    )
  },
  "sapata-com-parafuso-quadrada": {
    family: image(
      "family",
      "Família",
      `${finalBasePath}/sapata-com-parafuso-quadrada-family.png`,
      "Família de sapatas quadradas com furo central para parafuso em diferentes medidas e cores"
    ),
    product: image(
      "product",
      "Produto",
      `${finalBasePath}/sapata-com-parafuso-quadrada-product.png`,
      "Sapata quadrada com furo central para parafuso em vista de produto final"
    ),
    manual: image(
      "manual",
      "Instalação",
      `${finalBasePath}/sapata-com-parafuso-quadrada-manual.png`,
      "Sequência de instalação da sapata quadrada com parafuso separado"
    ),
    usage: image(
      "usage",
      "Uso",
      `${finalBasePath}/sapata-com-parafuso-quadrada-uso.png`,
      "Sapata quadrada com parafuso aplicada sob pé de madeira"
    )
  },
  "sapata-u": {
    family: image(
      "family",
      "Família",
      `${finalBasePath}/sapata-u-family-v2.png`,
      "Família de sapatas U em diferentes medidas, com e sem haste"
    ),
    productVariants: {
      "sem-haste": image(
        "product",
        "Produto",
        `${finalBasePath}/sapata-u-sem-haste-v2.png`,
        "Sapata U sem haste em vista de produto final"
      ),
      "com-haste": image(
        "product",
        "Produto",
        `${finalBasePath}/sapata-u-com-haste-v2.png`,
        "Sapata U com haste central em vista de produto final"
      )
    },
    manual: image(
      "manual",
      "Instalação",
      `${finalBasePath}/manual-sapata-u-v2.png`,
      "Sequência de instalação da sapata U por encaixe no tubo redondo"
    ),
    usage: image(
      "usage",
      "Uso",
      `${finalBasePath}/uso-sapata-u-v2.png`,
      "Sapata U aplicada em estrutura tubular de mobiliário"
    )
  }
};
...
const categoryCardImages = {
  ...
  "sapata-com-parafuso": image(
    "category",
    "Sapata com parafuso",
    `${finalBasePath}/sapata-com-parafuso-quadrada-family.png`,
    "Sapatas com furo central para fixação por parafuso em formatos redondo e quadrado"
  ),
  "sapata-u": image(
    "category",
    "Sapata U",
    `${finalBasePath}/sapata-u-family-v2.png`,
    "Sapatas U em diferentes medidas, com e sem haste"
  )
};

const categoryCardFamilySlugs = {
  "ponteira-interna-tubo": [
    "sapata-tubo-quadrado",
    "sapata-tubo-redondo",
    "sapata-tubo-oblongo"
  ],
  "sapata-base-lisa": ["sapata-lisa-quadrada", "sapata-lisa-redonda"],
  "sapata-com-parafuso": [
    "sapata-com-parafuso-quadrada",
    "sapata-com-parafuso-redonda"
  ],
...
const formatFamilyMap = {
  ...
  "sapata-com-parafuso": {
    redonda: "sapata-com-parafuso-redonda",
    quadrada: "sapata-com-parafuso-quadrada"
  },
  "sapata-u": {
    u: "sapata-u"
  }
...
const technicalDrawingOnlyCategories = new Set();
...
export function getCategoryCardGallery(categorySlug, fallbackImage) {
  ...
  const familyImages = (categoryCardFamilySlugs[categorySlug] || [])
    .map((familySlug) => {
      const gallery = getFamilyGallery(familySlug);
      return gallery.find((item) => item.type === "product") || gallery[0];
    })
    .filter(Boolean);
