...
// A preferencia nao tem expires_at (ver comentario em createMercadoPagoPreference),
// entao esta janela e o unico limite de validade de um link pendente: controla o
// reuso em preference/route.js e a expiracao do checkout pendente no cliente.
const DEFAULT_PREFERENCE_REUSE_MINUTES = 120;

export function getPreferenceReuseWindowMinutes() {
  const configured = Number(process.env.MERCADO_PAGO_PREFERENCE_TTL_MINUTES);
  return Number.isFinite(configured) && configured > 0
    ? configured
    : DEFAULT_PREFERENCE_REUSE_MINUTES;
}
