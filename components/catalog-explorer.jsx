...
function buildVariantSubject(family, variant) {
  return `Variante ${variant.sku} (${family.name})`;
}

function buildVariantMessage(family, variant) {
  return `Olá, quero confirmar a compra da variante ${variant.sku} da família ${family.name}.`;
}
            ...
            <>
              ...
              <div className="action-row">
                ...
                <a
                  ...
                  href={buildMailtoUrl(
                    brand.email,
                    buildVariantSubject(selectedFamily, selectedVariant),
