...
- Frete de lancamento usa estimativa manual por UF para postagem via Correios, com revisao operacional humana antes do envio. O adaptador para cotacao Melhor Envio pode ser homologado sem automatizar etiqueta/rastreio, com fallback manual quando credenciais/CEP de origem nao estiverem configurados.
...
- Estado externo em 28/06/2026:
  ...
  - Melhor Envio pode ser ativado para homologacao de cotacao em sandbox/producao apos token e CEP de origem. Compra de etiqueta, impressao e rastreio automaticos nao fazem parte do lancamento.
